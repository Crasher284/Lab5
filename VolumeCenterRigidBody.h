...
#ifndef LAB5_VOLUMECENTERRIGIDBODY_H
#define LAB5_VOLUMECENTERRIGIDBODY_H

#include "RigidBody.h"

class VolumeCenterRigidBody : public RigidBody {
    VolumeCenterRigidBody(int nx, int ny, int nz, double mass, double k, double b, double c, double d) : RigidBody(nx, ny, nz, k, b, c) {
        if(nx<=0 || ny<=0 || nz<=0){
...
#endif //LAB5_VOLUMECENTERRIGIDBODY_H
